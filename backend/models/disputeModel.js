...
const disputeSchema = new mongoose.Schema(
  {
    ...
    refundModel: { type: String, enum: ['Refund', 'InstallmentRefundBatch'], default: 'Refund' },
    refundId: { type: mongoose.Schema.Types.ObjectId, ref() { return this.refundModel || 'Refund'; }, default: null },
    refundError: { type: String, default: '', maxlength: 500 },
