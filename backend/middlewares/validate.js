...
export const schemas = {
  ...
  notificationPreferencesUpdate: Joi.object({
    ...
    product_approved: Joi.boolean(),
    product_rejected: Joi.boolean(),
    boost_expired: Joi.boolean(),
    promo_expired: Joi.boolean(),
    promotional: Joi.boolean(),
    shop_review: Joi.boolean(),
    shop_follow: Joi.boolean(),
    payment_pending: Joi.boolean(),
    payment_validated: Joi.boolean(),
    payment_proof_submitted: Joi.boolean(),
    order_created: Joi.boolean(),
    order_received: Joi.boolean(),
    order_placed: Joi.boolean(),
    order_accepted: Joi.boolean(),
    order_rejected: Joi.boolean(),
    order_full_payment_waived: Joi.boolean(),
    order_full_payment_received: Joi.boolean(),
    order_full_payment_ready: Joi.boolean(),
    ...
    delivery_distance_warning: Joi.boolean(),
    delivery_assigned: Joi.boolean(),
    delivery_in_progress: Joi.boolean(),
    delivery_completed: Joi.boolean(),
    order_delivering: Joi.boolean(),
    order_delivered: Joi.boolean(),
    order_delivery_fee_updated: Joi.boolean(),
    ...
    price_drop: Joi.boolean(),
    back_in_stock: Joi.boolean(),
    abandoned_cart: Joi.boolean(),
    seller_new_product: Joi.boolean(),
