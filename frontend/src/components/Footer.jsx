    ...
    <footer className="hidden md:block bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-sm text-gray-400">
            Marketplace premium opérée par ETS HD Tech Filial. Achetez et vendez en toute confiance,
            partout au Congo.
          </p>
        </div>
        ...
        <div>
          <h4 className="text-base font-semibold text-white">Communauté</h4>
          <p className="mt-3 text-sm text-gray-400">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col gap-2 text-xs text-gray-500 sm:flex-row sm:items-center sm:justify-between">
          <p>© {year} ETS HD Tech Filial — Tous droits réservés.</p>
          <p>HDMarket, marketplace sécurisée pour les vendeurs et acheteurs congolais.</p>
        </div>
      </div>
    </footer>
  );
