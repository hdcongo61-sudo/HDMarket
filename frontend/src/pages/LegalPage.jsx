...
const buildDocuments = (operator) => ({
  ...
  'retours-remboursements': {
    ...
    sections: [
      ...
      ['5. Remboursement', 'Après validation, HDMarket demande à PawaPay de renvoyer les fonds vers le compte Mobile Money utilisé pour le paiement d’origine. Le remboursement reste indiqué « en cours » jusqu’à la confirmation de PawaPay; son montant, sa référence et son statut apparaissent dans la commande. Les frais effectivement dus et non remboursables doivent avoir été annoncés avant achat.'],
