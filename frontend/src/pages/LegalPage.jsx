...
const documents = {
  ...
  'conditions-vente': {
    ...
    sections: [
      ...
      ['4. Paiement', 'Le paiement peut être réalisé par les moyens proposés dans l’application. Une preuve ou référence peut être demandée. HDMarket peut retarder la validation ou le versement en cas d’anomalie, contestation ou contrôle antifraude.'],
  ...
  'retours-remboursements': {
    ...
    sections: [
      ...
      ['5. Remboursement', 'Après validation, le remboursement est effectué par le portefeuille HDMarket ou le canal Mobile Money convenu. Le détail et la preuve apparaissent dans la commande. Les frais effectivement dus et non remboursables doivent avoir été annoncés avant achat.'],
