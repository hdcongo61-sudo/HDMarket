...
import { AdjustmentsHorizontalIcon, ArrowPathIcon, ChartBarIcon, CheckIcon, ShoppingBagIcon, XCircleIcon } from '@heroicons/react/24/outline';
...
export default function AdminBuyForMe() {
  ...
  if (loading) return <div className="flex min-h-[50vh] items-center justify-center"><ArrowPathIcon className="animate-spin text-[#e85d00]" /></div>;
