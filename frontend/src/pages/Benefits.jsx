  ...
  return (
    <div className="hd-commerce-shell min-h-screen bg-[#f5f5f5] pb-16 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
      ...
      <div className="mx-auto w-full max-w-3xl px-4">
        ...
        <SectionHeader id="assistants-commerce" eyebrow="Une expérience accompagnée" title="Des assistants pour acheter et vendre" subtitle="Disponibles après activation, avec des quotas d’utilisation et une validation humaine des contenus." />
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <FeatureCard icon={ChartBarIcon} title="Coach de vente" benefit="Analysez vos annonces et recevez des conseils vérifiables pour compléter les photos, les descriptions et mieux présenter vos produits." steps={['Ouvrez les statistiques de votre boutique', 'Demandez votre analyse et ouvrez les annonces à améliorer']} to="/seller/analytics" />
          <FeatureCard icon={SparklesIcon} title="Pack marketing à prix fixe" benefit="Une photo retouchée, deux bannières à exporter et des textes WhatsApp/Facebook. Vérifiez le tarif total avant le paiement; vos résultats sont conservés dans l’historique." steps={['Choisissez Pack marketing dans le studio ou le formulaire produit', 'Indiquez les caractéristiques réelles, vérifiez le prix et payez', 'Relisez les textes et téléchargez vos visuels']} to="/seller/image-edits" />
          <FeatureCard icon={ShoppingBagIcon} title="Assistant shopping" benefit="Précisez votre besoin, budget et ville. Comparez les prix et options d’annonces réelles du catalogue sans frais pour l’acheteur." steps={['Ouvrez M’aider à choisir dans le catalogue', 'Affinez votre demande et consultez les fiches proposées']} to="/products" />
          <FeatureCard icon={Square3Stack3DIcon} title="Compléments utiles" benefit="Demandez des suggestions de la même boutique depuis un produit ou votre panier. La compatibilité reste à vérifier sur les fiches; aucune remise n’est inventée." steps={['Choisissez Proposer des compléments', 'Vérifiez les options avant d’ajouter un article']} to="/cart" />
          <FeatureCard icon={ChatBubbleLeftIcon} title="Brouillons de réponses vendeur" benefit="Préparez une réponse avec le contexte autorisé de la commande. Seul le texte choisi est transmis; vous relisez et envoyez vous-même." steps={['Ouvrez une conversation dont vous êtes le vendeur', 'Copiez la question sans données personnelles', 'Corrigez puis insérez la réponse dans votre message']} to="/orders/messages" />
          <FeatureCard icon={ChartBarIcon} title="Pilotage fondateur" benefit="Un espace réservé au fondateur sépare ventes marchandes, recettes plateforme, dépenses saisies et consommation IA, avec un brief quotidien pour prioriser les actions." steps={['Disponible au fondateur dans Founder Intelligence', 'Enregistrez les factures et consultez le brief du jour']} />
        </div>

        <SectionHeader id="recherche-ia" eyebrow="Trouver plus facilement" title="Recherche par image et par voix" subtitle="L’IA vous aide à formuler votre recherche, puis HDMarket affiche les produits du catalogue." />
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <FeatureCard icon={SparklesIcon} title="Reconnaître un article sur une photo" benefit="Cadrez l’objet et demandez à l’IA de proposer un mot-clé. Vérifiez-le, puis recherchez des articles de ce type et de couleurs proches. Disponible lorsque l’IA est activée." steps={['Touchez l’icône photo dans la recherche', 'Cadrez l’article et choisissez Identifier avec l’IA', 'Vérifiez le mot-clé puis appliquez les filtres']} to="/search" />
          <FeatureCard icon={ChatBubbleLeftIcon} title="Dites ce que vous cherchez" benefit="Dictez votre recherche ou utilisez la transcription IA. L’interprétation peut extraire un type de produit, un budget et l’état neuf ou occasion que vous demandez explicitement." steps={['Ouvrez le microphone et dictez votre demande', 'Utilisez Comprendre ma demande avec l’IA si nécessaire', 'Relisez la proposition et les critères avant de rechercher']} to="/search" />
        </div>

        <SectionHeader id="creation-assistee" eyebrow="Créer vos annonces" title="Vos produits, mieux présentés" subtitle="Des outils gratuits de retouche et des assistants IA pour préparer vos annonces." />
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <FeatureCard icon={SparklesIcon} title="Nom et description avec l’IA" benefit="Décrivez les caractéristiques réelles du produit : l’assistant propose un nom et une description en français. Disponible lorsque le service est activé." steps={['Ouvrez Assistant IA dans le formulaire produit', 'Ajoutez les informations utiles et générez une proposition', 'Relisez, corrigez et appliquez le nom, la description ou les deux']} to="/seller/products" cta="Préparer mon annonce" />
          <FeatureCard icon={Square3Stack3DIcon} title="Studio photo complet gratuit" benefit="Recadrez en carré ou en forme libre, ajustez la lumière, ajoutez du texte et préparez vos photos avant publication." steps={['Ouvrez Studio complet sous une photo', 'Modifiez votre image puis appliquez les retouches']} to="/seller/products" />
          <FeatureCard icon={CheckBadgeIcon} title="Retirer le fond gratuitement" benefit="Le détourage local retire le fond sur votre appareil. Le premier usage télécharge le modèle ; aucun paiement par photo n’est demandé pour cet outil." steps={['Dans Studio complet, choisissez Retirer le fond', 'Vérifiez les contours et conservez la transparence en PNG ou WebP']} />
          <FeatureCard icon={SparklesIcon} title="Retouches photo IA à la demande" benefit="Changez le fond, retirez un élément du décor, améliorez la lumière ou décrivez une retouche. Chaque demande porte sur une photo, au tarif affiché fixé par l’administration. Disponible après activation du service." steps={['Préparez la photo et vos instructions', 'Vérifiez le prix puis payez avec PawaPay', 'Après confirmation, lancez la retouche et vérifiez le résultat', 'En cas d’échec, réessayez la même demande sans repayer ou contactez le support']} to="/seller/image-edits" cta="Mes retouches IA" />
        </div>
